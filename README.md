...
- Літня практика 2023
- Програмування мобільних пристроїв (ПМП)
- Програмування для Інтернет (ПДІ)
- Моделювання та аналіз програмного забезпечення (МАПЗ)
- Якість ПЗ та тестування (ЯПЗТ)
- Технології обробки зображень та відеопотоків (ТОЗВП)
